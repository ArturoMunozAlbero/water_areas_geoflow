...
st_write(grsf_approved_records_sf_centroid, file.path(getwd(), "data", paste0(entity$identifiers$id, "_centroids", ".gpkg")))
...
st_write(grsf_combined_sf, file.path(getwd(), "data", paste0(entity$identifiers$id, ".gpkg")))
